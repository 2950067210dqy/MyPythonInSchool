...
def allorderby(link,table,dbs):
    db=getDB("47.94.164.171",3306,"root","2591215997as",f'{dbs}','utf8')
    cursor=getCursor(db)
    soup=getSoup(link)
    num_list = soup.find_all("div", class_="num")
    name_list = soup.find_all("div", class_="info")
    ...
    for i in range(0,len(num_list)):
        ...
        try:
            ...
            print(time2)
            print(f"{dbs}的{table}视频抓取成功{id-1500}")
            id += 1
            # 提交到数据库执行
        except:
            # 发生错误时回滚
            ...
            time2 = time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time()))
            print(time2)
            print(f"{dbs}的{table}视频出错！{id-1500}  " + sql)
    db.commit()
    db.close()

def allfanju(link,table,dbs):
    db = getDB("47.94.164.171", 3306, "root", "2591215997as", f'{dbs}', 'utf8')
    cursor = getCursor(db)
    soup = getSoup(link)
    num_list = soup.find_all("div", class_="num")
    ...
    for i in range(0, len(num_list)):
        ...
        try:
            ...
            time2 = time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time()))
            print(time2)
            print(f"{dbs}的{table}番剧电影抓取成功!{id}")
            id += 1
            # 提交到数据库执行
        except:
             #发生错误时回滚
             ...
             time2 = time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time()))
             print(time2)
             print(f"{dbs}的{table}番剧电影出错！{id}  " + sql)
...
print(time1)
allorderby(link = "https://www.bilibili.com/ranking/all/0/0/1",table="bili",dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/1/0/1", table="cu_bili", dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/168/0/1", table="guochuang_bili",dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/3/0/1", table="music_bili", dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/129/0/1", table="dance_bili", dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/4/0/1", table="game_bili", dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/36/0/1", table="tec_bili",dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/188/0/1", table="shuma_bili",dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/160/0/1", table="life_bili", dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/119/0/1", table="guicu_bili",dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/155/0/1", table="fashion_bili",dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/5/0/1", table="yule_bili", dbs="bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/181/0/1", table="video_bili",dbs="bilibili")

allfanju(link="https://www.bilibili.com/ranking/bangumi/13/0/1", table="fanjuvideo_bili",dbs="bilibili")
allfanju(link="https://www.bilibili.com/ranking/bangumi/167/0/1", table="guo_fanjuvideo_bili",dbs="bilibili")

allfanju(link="https://www.bilibili.com/ranking/cinema/177/0/1", table="jilupian_bili",dbs="bilibili")
allfanju(link="https://www.bilibili.com/ranking/cinema/23/0/1", table="movie_bili", dbs="bilibili")
allfanju(link="https://www.bilibili.com/ranking/cinema/11/0/1", table="dianshiju_bili",dbs="bilibili")
print("-"*20+"爬取1天的完成"+"-"*20)

        #爬取7天的
allorderby(link="https://www.bilibili.com/ranking/all/0/0/7", table="bili", dbs="7bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/1/0/7", table="cu_bili",dbs="7bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/168/0/7", table="guochuang_bili",
                   dbs="7bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/3/0/7", table="music_bili", dbs="7bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/129/0/7", table="dance_bili",
                   dbs="7bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/4/0/7", table="game_bili",  dbs="7bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/36/0/7", table="tec_bili",  dbs="7bilibili")
...
allorderby(link="https://www.bilibili.com/ranking/all/155/0/7", table="fashion_bili",
                   dbs="7bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/5/0/7", table="yule_bili", dbs="3bilibili")
...
print("-" * 20 + "爬取3天的完成" + "-" * 20)
        #爬3天的
allorderby(link="https://www.bilibili.com/ranking/all/0/0/3", table="bili",dbs="3bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/1/0/3", table="cu_bili", dbs="3bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/168/0/3", table="guochuang_bili",
                   dbs="3bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/3/0/3", table="music_bili",dbs="3bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/129/0/3", table="dance_bili",
                   dbs="3bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/4/0/3", table="game_bili",  dbs="3bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/36/0/3", table="tec_bili",  dbs="3bilibili")
...
allorderby(link="https://www.bilibili.com/ranking/all/155/0/3", table="fashion_bili",
                   dbs="3bilibili")
allorderby(link="https://www.bilibili.com/ranking/all/5/0/3", table="yule_bili",  dbs="bilibili")
